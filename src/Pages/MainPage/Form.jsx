...
const Form = () => {
  ...
  // gösterilecek input level'i state'i
  ...
  //   gönderme işleminde çalışacak fonksiyon
  const handleSubmit = () => {
    ...
    <div className="mt-5 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-5 gap-4 items-center">
        ...
        <BiSolidDownArrowCircle
          onClick={() => {
            title ? setInputLevel(1) : toast.warning("İlgili alanı doldurunuz");
          }}
          className="text-2x1 cursor-pointer hover:text-gray-400"
        />
      </div>
          ...
          <div className="flex">
            <BiSolidDownArrowCircle
              onClick={() => {
                content
                  ? setInputLevel(2)
                  : toast.warning("İlgili alanı doldurunuz");
              }}
              className="text-2x1 cursor-pointer hover:text-gray-400"
            />
            <AiFillCloseCircle
